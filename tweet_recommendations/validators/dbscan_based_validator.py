...
from tweet_recommendations.other_methods.dbscan_based_method import (
    DBScanBasedMethod
)
...
dbs = DBScanBasedMethod(args.w2v_path, verbose=True)
...
print(
    dbs.transform(["Co by tu dzisiaj zrobić ...", "Wiozę szwagra na wybory"])
)
print(
    dbs.transform(
        [
